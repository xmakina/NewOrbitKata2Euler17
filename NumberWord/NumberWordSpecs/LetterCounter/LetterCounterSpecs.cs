namespace NumberWordSpecs.LetterCounter
{
    ...
    public abstract class WithLetterCounter : WithSubject<LetterCounter>
    {
    ...
    public class when_given_one : WithLetterCounter
    {
    ...
    public class when_given_forty_two : WithLetterCounter
    {
    ...
    public class when_given_one_hundred : WithLetterCounter
    {
    ...
    public class when_given_three_hundred_and_forty_two : WithLetterCounter
    {
